...
//    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("search-item.html");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String productId = request.getParameter("product_desc");
		...
		try {
			...
			String query = "SELECT * FROM eproducts WHERE product_desc LIKE '%mobile%'";
			...
			if(rst.next()) {
			     ...
			     response.getWriter().println("<p>Product Quantity: " + quantity + "</p>");
			}else {
